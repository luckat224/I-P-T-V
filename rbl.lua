    ...
    animator.AnimationPlayed:Connect(function(track)
        ...
        if isEnabled then
            ...
            if AoESkills[rawId] then
                ...
                -- CHIÊU ĐỊNH HƯỚNG & ĐẮM TAY M1 CHẾ ĐỘ THÔNG MINH (KHÔNG CẦN SỐ STUDS CỨNG)
                if dist <= 18 then
                    shouldDodge = true
                elseif dist <= 85 then
                    ...
                    -- Chỉ né khi hướng vung chiêu/bắn đạn của đối thủ thực sự trỏ thẳng vào thân bạn (dot >= 0.3)
                    if dot >= 0.3 then
                        shouldDodge = true
                    end
                end
